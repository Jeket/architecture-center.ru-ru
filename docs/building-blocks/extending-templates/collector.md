...
<span data-ttu-id="d04f4-162">Затем мы передаем два параметра в **шаблон сборщика**:</span><span class="sxs-lookup"><span data-stu-id="d04f4-162">We pass two parameters to the **collector template**:</span></span>
