...
* **Жизненный цикл**. Подписки представляют жизненный цикл службы, например производство или разработку.
* **Подразделение**. Подписки представляют подразделения в организации.
...
Корпорация Майкрософт предоставляет несколько средств для визуализации, отслеживания и управления вашими расходами. Мы также предоставляем полный набор интерфейсов API, которые позволяют настраивать и интегрировать управление затратами в свои собственные инструменты и панели мониторинга. Эти средства бессистемно группируются в возможности портала Azure и внешние возможности
...
* **Управление затратами Azure**. Этот продукт является результатом приобретения Cloudyn корпорацией Майкрософт и позволяет управлять и анализировать затраты на Azure, а также на других поставщиков общедоступного облака. Есть как бесплатные, так и платные уровни, с большим количеством возможностей, как показано в [Обзоре](/azure/cost-management/overview).
