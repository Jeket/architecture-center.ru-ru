...
> [!IMPORTANT]
> Azure **владелец учетной записи** отвечает за финансовых обязательств, связанной с подпиской, но **владелец рабочей нагрузки** имеет те же разрешения. **Владелец учетной записи** должен доверять **владельцу рабочей нагрузки** в вопросах развертывания ресурсов, которые находятся в пределах бюджета подписки.
