...
Напротив _нефункциональные_ требования относятся свойства, такие как службы [надежности](../../reliability/index.md) и [масштабируемость](../../checklist/scalability.md). Эти свойства отличаются от функциональных требований, потому что не влияют напрямую на итоговую функциональность любого из компонентов службы. Но эти нефункциональные требования влияют на _производительность_ и _непрерывность работы_ службы.
...
! [ПРИМЕЧАНИЕ] Определение требований для обеспечения устойчивости, включая объяснение RPO, RTO, соглашение об уровне ОБСЛУЖИВАНИЯ и связанные понятия рассматриваются более подробно в [Разработка требований для устойчивых приложений Azure](../../reliability/requirements.md).
...
3. Ответственные со стороны проектирования и служб проверяют текущее состояние ведения журналов и мониторинга для перечисленных на предыдущем шаге служб. Надежные ведение журналов и мониторинг очень важны, чтобы определить компоненты службы, которые влияют на несоответствие требованиям нефункциональные требования. Если ведение журналов и мониторинг не организованы на должном уровне, следует создать и реализовать план по их организации.
...
- [Проектирование надежных приложений Azure](../../reliability/index.md).
