...
Службу контейнеров Azure можно использовать для настройки и подготовки кластера Docker. Служба контейнеров Azure поддерживает несколько популярных оркестраторов контейнеров, среди которых Kubernetes, DC/OS и Docker Swarm.
...
На схеме ниже показана архитектура микрослужб с использованием Azure Service Fabric.
