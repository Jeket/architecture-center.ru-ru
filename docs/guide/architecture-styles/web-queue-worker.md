...
- Внешний интерфейс реализован в виде веб-приложение службы приложений Azure, а рабочая роль реализуется как приложения функций Azure. Веб-приложения и приложения-функции, связанные с планом службы приложений, который предоставляет экземпляры виртуальных Машин.
...
- Рекомендуется поместить веб-приложения и приложения-функции в отдельных планах службы приложений. Таким образом, они могут масштабироваться независимо друг от друга.
