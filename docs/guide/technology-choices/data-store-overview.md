...
- [База данных Azure для MariaDB][mariadb]
...
Соответствующие службы Azure: [Cosmos DB][cosmosdb]
...
Соответствующие службы Azure: [Использование HBase в HDInsight][hbase]
...
- [Обозреватель данных Azure](https://azure.microsoft.com/services/data-explorer/)
...
Соответствующие службы Azure: [Поиск Azure][search]
...
Соответствующие службы Azure: [Аналитика временных рядов][time-series]
...
Соответствующие службы Azure: [Хранилище BLOB-объектов][blob]
...
Соответствующие службы Azure: [Хранилище файлов][file-storage]
