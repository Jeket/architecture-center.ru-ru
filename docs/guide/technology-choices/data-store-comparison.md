...
<tr><td>**Тип данных**</td>
    <td>
        <ul>
            ...
            <li>Таблицы измерений часто включают в себя несколько исторических версий сущности, называемых *медленно изменяющимися измерениями*.</li>
        </ul>
    </td>
</tr>
<tr><td>**Примеры**</td>
