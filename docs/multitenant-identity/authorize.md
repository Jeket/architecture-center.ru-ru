...
В классе запуска определите именованную политику, содержащую одно или несколько требований. Если существует несколько требований, пользователь должен выполнить *каждое* из них, чтобы пройти авторизацию. Следующий код определяет две политики:
