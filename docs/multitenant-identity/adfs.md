...
> [!NOTE]
> В этой статье предполагается, что в качестве протокола аутентификации приложение использует OpenID Connect. Другим вариантом является использование WS-Federation.
>
