...
* В приложении настройте установку заголовков CORS. Например, примените рекомендации из раздела документации по ASP.NET Core [Enabling Cross-Origin Requests (CORS)](/aspnet/core/security/cors) (Включение запросов независимо от источника (CORS)).
