...
* Если вы регулярно выполняете запросы, которые ищут данные с использованием других полей, кроме ключей секций и строк, рассмотрите возможность реализации [Index Table Pattern] или использования отдельного хранилища данных с поддержкой индексирования, например Cosmos DB.
