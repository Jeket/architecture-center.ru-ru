...
|Подсистема балансировки нагрузки |Группа ресурсов |От 1 до 80 |Без учета регистра |Буквы, цифры, дефис, символ подчеркивания, точка |`<service or role>-lb` |`profx-lb` |
|Конфигурация правил балансировки нагрузки |Подсистема балансировки нагрузки |От 1 до 80 |Без учета регистра |Буквы, цифры, дефис, символ подчеркивания, точка |`<descriptive context>` |`http` |
