...
> [!NOTE]
> Автоматическое масштабирование относится в основном к вычислительным ресурсам. Базу данных или очередь сообщений также можно масштабировать горизонтально, но обычно это подразумевает [секционирование данных](./data-partitioning.md), которое не так просто автоматизировать.
