...
В конечном счете _любое_ приложение, которое имеет какую-либо форму функциональных возможностей поиска, может воспользоваться преимуществами наличия специальной службы поиска.
