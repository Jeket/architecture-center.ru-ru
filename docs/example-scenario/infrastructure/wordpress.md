...
Другие темы, масштабируемость, см. в разделе [контрольный список масштабируемости] [масштабируемости] в центре архитектуры Azure.
...
Общие рекомендации по разработке отказоустойчивые сценарии см. в разделе [Проектирование надежных приложений Azure](../../reliability/index.md).
