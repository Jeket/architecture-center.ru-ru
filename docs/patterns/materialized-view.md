...
![Рисунок 2. Использование шаблона материализованного представления для создания сводки о продажах](./_images/materialized-view-summary-diagram.png)
