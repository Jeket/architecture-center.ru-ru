...
- [Управление удостоверениями мультитенантных приложений в Microsoft Azure](/azure/architecture/multitenant-identity)
- [Мультитенантные приложения Azure](/azure/dotnet-develop-multitenant-applications)
