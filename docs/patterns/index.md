...
|                [Прерыватель](./circuit-breaker.md)                |                                                     Обработка ошибок при подключении к удаленной службе или ресурсу, устранение которых может занять непредсказуемое количество времени.                                                     |
...
| [Консолидация вычислительных ресурсов](./compute-resource-consolidation.md) |                                                                        Объединение нескольких задач и операций в единый вычислительный блок                                                                        |
...
| [Издатель/Подписчик](./publisher-subscriber.md) | Настройка в приложении возможности асинхронно объявлять событие для нескольких объектов-получателей без взаимозависимости между отправителями и получателями. |
