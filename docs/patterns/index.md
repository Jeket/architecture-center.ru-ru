...
description: Конструктивные шаблоны облачный решений для создания надежных, масштабируемых, безопасных приложений в облаке
...
| [Издатель/Подписчик](./publisher-subscriber.md) | Настройка в приложении возможности объявлять событие для нескольких объектов-получателей одновременно без взаимозависимости между отправителями и получателями. |
