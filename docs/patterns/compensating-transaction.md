...
description: "Отмена работы, выполняемой серией шагов, которые вместе определяют операцию по итоговому согласованию."
