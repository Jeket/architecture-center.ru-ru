...
ms.locfileid: "54482722"
---
# <a name="designing-microservices-domain-analysis"></a>Проектирование микрослужб. Анализ домена
...
## <a name="drone-delivery-analyzing-the-business-domain"></a>Доставка с помощью дронов. Анализ предметной области для бизнеса
