...
На уровне приложений SAP Azure предлагает широкий диапазон размеров виртуальных машин для вертикального и горизонтального масштабирования. Полный список см. в [примечании SAP № 1928533](https://launchpad.support.sap.com/#/notes/1928533) о поддерживаемых продуктах и типах виртуальных машин Azure для приложений SAP в Azure (для доступа необходима учетная запись SAP Service Marketplace). По мере того, как мы продолжаем сертифицировать больше типов виртуальных машин, вы можете масштабировать ресурсы с помощью одного и того же облачного развертывания.
