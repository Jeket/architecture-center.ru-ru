---
title: Базовые сценарии корпоративной интеграции в Azure
titleSuffix: Azure Reference Architectures
description: Рекомендуемая архитектура для реализации простого шаблона корпоративной интеграции с помощью Azure Logic Apps и Управления API Azure.
services: logic-apps
author: mattfarm
