...
---
# <a name="simple-enterprise-integration"></a>Простая корпоративная интеграция
...
Azure Integration Services — это набор служб для интеграции приложений и данных. Описываемая архитектура использует две из этих служб — [Logic Apps][logic-apps] (для оркестрации рабочих процессов) и [управление API][apim] (для создания каталогов API).
...
- **Служба управления Azure API.** [Управление API][apim] — это управляемая служба для публикации каталогов API HTTP с целью упрощения их обнаружения и повторного использования. Служба управления API состоит из двух взаимосвязанных компонентов:
...
* Узнайте об [эталонной архитектуре корпоративной интеграции с использованием очередей и событий](/azure/logic-apps/logic-apps-architectures-enterprise-integration-with-queues-events).
