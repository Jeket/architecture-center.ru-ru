...
3. Повторите шаг 1 для файла `spoke2.json`.

4. Выполните команду `azbb`, чтобы развернуть вторую среду виртуальной сети периферийных зон, как показано ниже.
...
5. Используйте пароль, указанный в строке 37 файла `onprem.json`, чтобы подключиться к виртуальной машине.

6. Используйте команду `ping`, чтобы проверить возможность подключения к виртуальным машинам jumpbox в каждой периферийной зоне, как показано ниже.
