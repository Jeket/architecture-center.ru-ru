...
### <a name="test-connectivity-to-the-hub-vnet-mdash-windows-deployment"></a>Проверка возможности подключения к виртуальной сети концентратора (развертывание Windows)
...
### <a name="test-connectivity-to-the-hub-vnet-mdash-linux-deployment"></a>Проверка возможности подключения к виртуальной сети концентратора (развертывание Linux)
...
### <a name="test-connectivity-to-the-spoke-vnets-mdash-windows-deployment"></a>Проверка возможности подключения к виртуальным сетям периферийных зон (развертывание Windows)
...
### <a name="test-connectivity-to-the-spoke-vnets-mdash-linux-deployment"></a>Проверка возможности подключения к виртуальным сетям периферийных зон (развертывание Linux)
