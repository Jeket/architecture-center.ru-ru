...
В Azure доступны виртуальные машины разных размеров. Рекомендуется использовать [хранилище класса Premium][premium-storage], так как оно отличается низкой задержкой и высокой производительностью, а также [поддерживается виртуальными машинами определенных размеров][premium-storage-supported]. Если отсутствует специализированная рабочая нагрузка, например высокопроизводительные вычисления, выберите виртуальную машину одного из этих размеров. См. дополнительные сведения о [размерах виртуальных машин][virtual-machine-sizes].
