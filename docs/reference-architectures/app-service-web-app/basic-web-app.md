...
description: Рекомендуемая архитектура для базовых веб-приложений, работающих в Azure.
author: MikeWasson
ms.date: 12/12/2017
...
ms.locfileid: "54485083"
---
# <a name="run-a-basic-web-application-in-azure"></a>Запуск базового веб-приложения в Azure

Эта эталонная архитектура включает ряд проверенных методов для создания веб-приложения, в котором используются [Служба приложений Azure][app-service] и [База данных SQL Azure][sql-db]. [**Разверните это решение**](#deploy-the-solution).

![Эталонная архитектура для базового веб-приложения в Azure](./images/basic-web-app.png)
...
Если вам нужен более высокий уровень службы или производительности для базы данных SQL, вы можете масштабировать отдельные базы данных без простоя приложения. Дополнительные сведения см. в [описании уровней служб Базы данных SQL и возможностей, доступных на каждом уровне службы][sql-db-scale].
...
Выполните нагрузочное тестирование с использованием специального средства, например [Azure DevOps][azure-devops] или [Visual Studio Team Foundation Server][tfs]. Общее описание анализа производительности в облачных приложениях вы найдете в [руководстве по анализу производительности для начинающих][perf-analysis].
