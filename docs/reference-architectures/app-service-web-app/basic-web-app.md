...
1. Подготовка ресурсов Azure. Для выполнения этого шага мы рекомендуем использовать [шаблоны Azure Resoure Manager][arm-template]. Шаблоны облегчают автоматическое развертывание с помощью PowerShell или интерфейса командной строки Azure.
