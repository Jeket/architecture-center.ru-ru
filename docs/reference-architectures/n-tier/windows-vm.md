...
ms.locfileid: "50916317"
---
# <a name="run-a-windows-vm-on-azure"></a>Запуск виртуальной машины Windows в Azure

В этой статье описаны способы запуска виртуальных машин Windows в Azure. Она содержит рекомендации для подготовки виртуальной машины, а также компоненты хранилища и сетевые компоненты. [**Разверните это решение**.](#deploy-the-solution)
