...
Если вы читали документацию о больших данных, скорее всего, вам попадался термин _Data Lake_. Вы могли видеть его в названии продукта или в качестве концепции для хранения больших объемов данных. 

Data Lake состоит из компонентов хранения и обработки данных. Хранилище Data Lake создано для нескольких целей: обеспечение отказоустойчивости, бесконечной масштабируемости и высокой пропускной способности при получении данных любых форм и размеров. Компонент обработки Data Lake включает в себя один или несколько модулей обработки, созданных для этих целей, и может работать с данными, хранящимися в Data Lake в нужном масштабе.
...
Еще один часто используемый термин в сценариях работы с данными — это _киоск данных_. Как правило, киоск данных — это хранилище данных, которые очищены, упакованы и структурированы для простого использования. В отличие от киоска данных Data Lake принимает необработанные данные, оставляя их в исходном виде или в наименее обработанной форме, чтобы разрешить отправлять запросы разными способами и в разные моменты времени. Если данные очищены и структурированы особым образом, например как в киоске данных, очень трудно адаптировать способ обработки и анализа данных при появлении новых вопросов и средств в будущем. Поэтому в Data Lake компоненты хранения и обработки данных выступают отдельными сущностями.
