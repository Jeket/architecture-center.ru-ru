...
---
# <a name="choosing-a-data-warehouse-in-azure"></a>Выбор хранилища данных в Azure

Хранилищем данных называется централизованный, организационный и реляционный репозиторий данных, собранных из одного или нескольких разнородных источников. В этой статье сравниваются варианты хранилищ данных в Azure.

> [!NOTE]
> Дополнительные сведения об использовании хранилища данных см. в статье [Data warehousing and data marts](../scenarios/data-warehousing.md) (Хранилища и киоски данных).

## <a name="what-are-your-options-when-choosing-a-data-warehouse"></a>Варианты при выборе хранилища данных
...
| --- | --- | --- | --- | --- | --- | -- |
| Управляемая служба | Yes | Нет  | Yes | Да <sup>1</sup> | Да <sup>1</sup> |
| Требуется оркестрация данных (содержит копию простых или исторических данных) | Нет  | Нет  | Yes | Yes | Yes |
| Простая интеграция нескольких источников данных | Нет  | Нет  | Yes | Yes | Yes |
| Поддержка приостановки вычислительных ресурсов | Нет  | Нет  | Yes | Нет <sup>2</sup> | Нет <sup>2</sup> |
| Реляционное хранилище данных | Yes | Yes |  Yes | Нет  | Нет  |
| Отчеты в реальном времени | Yes | Yes | Нет  | Нет  | Yes |
...
| Авторизация  | Yes | Yes | Yes | Yes | Да <sup>1</sup> | Да <sup>1</sup> |
| Аудит  | Yes | Yes | Yes | Yes | Да <sup>1</sup> | Да <sup>1</sup> |
| Шифрование неактивных данных | Да <sup>2</sup> | Да <sup>2</sup> | Да <sup>2</sup> | Да <sup>2</sup> | Да <sup>1</sup> | Да <sup>1</sup> |
| Безопасность на уровне строк | Yes | Yes | Yes | Нет  | Да <sup>1</sup> | Да <sup>1</sup> |
| Поддержка брандмауэров | Yes | Yes | Yes | Yes | Да <sup>3</sup> | Да <sup>3</sup> |
| Динамическое маскирование данных | Yes | Yes | Yes | Нет  | Да <sup>1</sup> | Да <sup>1</sup> |
