...
| --- | --- | --- | --- | --- | --- | --- |
| Управляемая служба | Yes | Yes | Да <sup>1</sup> | Да <sup>1</sup> | Yes | Yes |
...
| | База данных SQL | Хранилище данных SQL. | HBase/Phoenix в HDInsight | Hive LLAP в HDInsight | Службы Azure Analysis Services | База данных Cosmos |
| --- | --- | --- | --- | --- | --- | --- |
| Избыточные региональные серверы для высокого уровня доступности  | Yes | Yes | Yes | Нет  | Нет  | Yes | Yes |
